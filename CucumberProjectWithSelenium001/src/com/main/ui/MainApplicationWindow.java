...
//	 	lblHomePage.setIcon(new ImageIcon("E:\\CMS PoCs\\selenium_testing\\logos_images\\cmpyimg.PNG"));
		...
		btnRunTestsMode.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ImageIcon icon = new ImageIcon("E:\\CMS PoCs\\selenium_testing\\logos_images\\more imgs\\iconfortestingapp.jpg");
				String s = (String)JOptionPane.showInputDialog(
				                    btnRunTestsMode, this,
				                    "Choose the browser:\n"
				                    + "\"Green eggs and...\"",
				...
				if ((s != null) && (s.length() > 0)) {
				    if(s.equalsIgnoreCase("chrome")) {
				    	new TestRunRobotforChrome();
				    }else if(s.equalsIgnoreCase("firefox")) {
				    	//new TestRunRobotforFirefox();
				    }else {
				    	//new TestRunRobotforMSEdge();
				    }
				    return;
			}}});
