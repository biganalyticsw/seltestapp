...
public class TestClass002 {	
	...
	ScreenCaptureUtilityinPac.captureScreenImage(timeStamp+"010");
	...
	ScreenCaptureUtilityinPac.captureScreenImage(timeStamp+"012");
	...
	ScreenCaptureUtilityinPac.captureScreenImage(timeStamp+"014");
	...
	ScreenCaptureUtilityinPac.captureScreenImage(timeStamp+"015");
